...
# random.seed(252)
class RedPacketGame4:
    def __init__(self, total_members=21, absent_member=[18, 19, 20]):  # 允许多个缺席委员
    ...
    def start_round(self, absent_member, last_winner):
        ...
        all_members_sent = all(self.red_packet_data[i]["sent"] > 0 for i in range(len(self.members_in_game)-2))  # 检查编号1到20的委员是否都发过红包
        self.flag += 1
